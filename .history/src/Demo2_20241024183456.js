...
const Demo2 = () => {
    return (
        <div className='container'>
            ...
            <link rel="stylesheet" href="E:/b1/css/bootstrap.min.css"/>
                <script src="E:/b1/js/bootstrap.min.js"></script>
                <div className='row'>
                ...
                <div className='row mb-3'>
                    <button type='submit' className='btn btn-primary col-6 offset-3'>Submit</button>
                </div>
        </div>
    )
}
