...
const Demo1 = () => {
  return (
    <div className='container-fluid'>
      ...
      <div className='row'>
        <div className='col-3  order-sm-last bg-success' >AAA</div>
        <div className='col-3  order-sm-0 bg-danger' >BBB</div>
        <div className='col-3 order-sm-first bg-primary' >CCC</div>
        <div className='col-3 order-sm-1 bg-danger' >DDD</div>
      </div>
